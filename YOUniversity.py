...
if 'Desired Degree Category' in options:
...
if st.button('Find My Dream Schools'):
   ...
   # col7.metric("Admissions Rate", value = dfUse['ADM_RATE'])
    dfUse.rename(columns = {"INSTNM":"Institution", "STABBR":"State", "INSTURL":"Website", "ACTCMMID" : "ACT Average","ADM_RATE": "Admissions Rate", "CITY" : "City", "SAT_AVG" : "SAT Average" , 'UGDS' : 'Undergraduates','COSTT4_A' : "Expected Attendance Cost" }, inplace = True)
...
search = st.text_input('Exact University Name: ', '')
dfSearch = df[df['INSTNM'] == search]
